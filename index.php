...
<html lang="en">
  <head>
    ...
    <title>Ayo Cek Corona</title>
  </head>
  <body>
    <nav class="navbar py-2 navbar-expand-lg navbar-light">
      <div class="container">
        <a class="navbar-brand" href="#"
          ><img src="gambar/logocorona.png" width="147" alt="logo"
        /></a>
        <button
      ...
      <div class="container">
        <div class="row">
          <div class="col align-self-center">
            <h1 class="mb-4">Ayo Cek Corona!</h1>
            <p class="mb-4">
              Ayo Cek Corona! Merupakan sistem informasi berbasis Web Based yang memanfaatkan teknologi Sistem Pakar didalamnya. Dengan menggunakan sistem pakar ini pengguna dapat mengenali atau memeriksakan keluhan yang dialaminya hanya dengan menjawab pertanyaan yang diberikan oleh sistem, dan kemudian pengguna dapat melihat hasil Test dengan hasil yang direpresentasikan dalam bentuk persentase.
            </p>
            <a class="btn btn-primary" href="register.php" role="button">Ayo Mulai!</a>
          </div>
          <div class="col d-none d-sm-block">
            <img width="500" src="gambar/awal.jpg" alt="hero" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="alur">
      ...
      <div id="konten2" class="container konten">
        <h2 style="font-weight: bold;text-align: center;">Alur Kerja Sistem Pakar Cek Corona Yuk!</h2>
        <div class="card-deck">
          <div class="card">
            <h5 class="card-title">Login</h5>
            <img src="gambar/loginn.jpg" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            ...
            <img src="gambar/tes.jpg" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            ...
            <img src="gambar/hasill.jpg" class="card-img-top" alt="...">
